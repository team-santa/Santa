                ...
                .andDo(document("member-get-reviewBoards",
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath("[].writer").type(JsonFieldType.STRING).description("게시자"),
                                        fieldWithPath("[].modifiedAt").type(JsonFieldType.STRING).description("리뷰게시판 수정날짜"),
                                        fieldWithPath("[].title").type(JsonFieldType.STRING).description("리뷰게시판 제목"),
                                        fieldWithPath("[].views").type(JsonFieldType.NUMBER).description("리뷰게시판 조회수"),
                                        fieldWithPath("[].tagList").type(JsonFieldType.ARRAY).description("리뷰게시판 태그"),
                                        fieldWithPath("[].thumbnail").type(JsonFieldType.STRING).description("리뷰게시판 이미지 경로")
